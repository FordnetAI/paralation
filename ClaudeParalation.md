...
- SETTING COLLISION, raised with Tim and unresolved: the existing story text is explicitly San Diego (Mission Beach photo, Arizona forest trip, US suburbs), and the cul-de-sac art has US mailboxes and a basketball hoop. A British village next door is incoherent without a story pass. Options offered: relocate the story to England (edit ~6 examine lines in maps.js + regen mailbox/hoop as UK equivalents) or re-skin the village American. AWAIT TIM'S CALL before touching story text.
